( function( $ ) {
	...
	$( function() {
		...
		$('#woocommerce_sixbank_credit_merchant_key').attr('minlength', 10);
		//$('#woocommerce_sixbank_debit_merchant_key').attr('maxlength', 40);
		$('#woocommerce_sixbank_debit_merchant_key').attr('minlength', 10);
		//$('#woocommerce_sixbank_slip_merchant_key').attr('maxlength', 40);
		$('#woocommerce_sixbank_slip_merchant_key').attr('minlength', 10);
		//$('#woocommerce_sixbank_transfer_merchant_key').attr('maxlength', 40);
		$('#woocommerce_sixbank_transfer_merchant_key').attr('minlength', 10);
		...
		$('#sixbank_subscription_period').on('change');
