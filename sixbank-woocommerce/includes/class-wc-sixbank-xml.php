...
class WC_Sixbank_XML extends SimpleXMLElement {
	 ...
	 * Add account data.
	 *
	 * @param string $number Sixbank account number.
	 * @param string $key    Sixbank account key.
	 */
	...
	public function add_order_data( $order, $total, $currency, $language, $description = '', $soft_descriptor = '' ) {
		...
		$order_data->addChild( 'numero', $order->get_id() );
	...
	public function add_card_data( $card_number, $card_expiry, $card_cvv, $holder_name ) {
		...
		// For more information see page 11 of Manual Desenvovedor de Webservice Sixbank v. 2.54.
